...
export interface JsonPipeOptions extends JsonSimplifierOptions {
     ...
     */
    messageIdPropertyProvider: (level: LogLevel, ...args: Array<unknown>) => string;
...
export function getDefaultJsonPipeOptions()
    : JsonPipeOptions & { levelPropertyName: string, timestampPropertyName: string, messageIdPropertyName: string } {
    return {
